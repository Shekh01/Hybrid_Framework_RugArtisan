...
public class Checkout_page_Company_name extends Base{
	@Test
...
Thread.sleep(3000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='shipping[company_name]'])[1]")).sendKeys("hinffhhinffhhinffhhinffhhinffhhinffh");
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("(//input[@id='shipping[company_name]'])[1]")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='shipping[company_name]'])[1]")).sendKeys("hinfashinfashinfashinfashinfasEWDSDD");
		Thread.sleep(5000);
